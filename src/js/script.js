...
$(function () {
  ...
  function topFirst() {
    $('.c-mv-top__1').css({'opacity': '0'});
    $('.c-mv-top__2').css({'opacity': '0'});
    $('.c-mv-top__3').css({'opacity': '0'});
    $('.c-mv-top__4').css({'opacity': '0'});
    $('.c-mv-top__5').css({'opacity': '0'});
    // $('.mv-bottom_slogan').css({'opacity': '0'});
    // $('.mv-bottom_img').css({'opacity': '0'});
